...
<?php if (!WC_Subscriptions_Cart::cart_contains_subscription()) : ?>
    <div class="woocommerce-form-login-toggle">
        <?php wc_print_notice(apply_filters('woocommerce_checkout_login_message', __('Returning customer?', 'woocommerce')) . ' <a href="' . get_permalink(get_option('woocommerce_myaccount_page_id')) . '">' . __('Click here to login', 'woocommerce') . '</a>', 'notice'); ?>
    </div>
<?php endif; ?>
<?php
