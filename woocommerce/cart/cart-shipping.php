...
<tr class="shipping">
	...
	<td data-title="<?php echo esc_attr( $package_name ); ?>">
		...
		<?php if ( ! empty( $show_shipping_calculator ) ) : ?>
            ...
            <p class="shipping-description"><strong>International Shipping:</strong> If you are interested in shipping physical products internationally please contact us for a shipping quote. Digital products can be used worldwide.</p>
        <?php endif; ?>
	</td>
</tr>
